        ...
        <form name="forml" action="CadProb.php" method="GET">
          ...
          <div class="form-group">
            <div class="col-sm-10">
             ...
             <input type="text" name="descricao" id="descricao" maxlength="45" required class="form-control" placeholder="">
             <small id="descricaoHelpBlock" class="form-text text-muted">
                Digite uma breve descriçao para do problema
              </small>
             </div>
